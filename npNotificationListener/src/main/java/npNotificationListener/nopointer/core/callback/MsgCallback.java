...
public abstract class MsgCallback {
     ...
     */
    public abstract void onAppMsgReceive(String packName, String from, String msgContent);
     ...
     * 通知栏来电提醒
     */
    public void onNotificationInCall(String from, String content, int userHandResult) {
     ...
     * 通知栏短信提醒
     */
    public void onNotificationReceiveSms(String phoneNumber, String contactName, String messageContent) {
