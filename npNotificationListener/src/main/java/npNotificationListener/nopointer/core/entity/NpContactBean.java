package npNotificationListener.nopointer.core.entity;

/**
 * 通讯录联系人信息，不保证所有手机里面这些字段是可以取出数据，绝大部分手机
 */
public class NpContactBean {
    private String display_name_alt;
    private String display_name;
    private String data1;
    private String data4;

    public NpContactBean(String display_name_alt, String display_name, String data1, String data4) {
